...
from src.api.di.providers.holder import HolderProvider, holder_provider, user_dao
...
def setup_di(app: FastAPI, pool: async_sessionmaker[AsyncSession]) -> None:
    ...
    app.dependency_overrides[user_dao] = (
        app.dependency_overrides[holder_provider].user
    )
